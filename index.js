...
if (!text) return reply(`Kirim perintah ${prefix + command} *Irfan|bot*`)
if (!text.includes('|')) return reply(`Kirim perintah ${prefix + command} *Irfan|bot*`)
mm = args.join(' ')
m1 = mm.split("|")[0];
m2 = mm.split("|")[1]; 
reply(lang.wait())
